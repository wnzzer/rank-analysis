...
常用 queueId 与中文名（输入特征里每局都附带 queueName，请优先用 queueName 判断模式）：
  排位类：420 单双排位，440 灵活组排
  匹配/休闲：430 匹配模式，480 快速匹配
  娱乐模式：450 大乱斗，1300 觉醒之战，1700 斗魂竞技场，900/1900 无限火力，1400 终极魔典，75/98 海克斯乱斗，700 冠军杯赛，920 飞升
  其他未列出的 queueId 一律视作"娱乐模式"——不要写成"排位"
